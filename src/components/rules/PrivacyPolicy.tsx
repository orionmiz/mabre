export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p>○ 이 개인정보처리방침은 2022년 6월 13일부터 적용됩니다.</p>
      <h2>제1조(개인정보의 처리 목적)</h2>
      <p>
        {"<마브레>"}은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
      ...
      <p>
        {"<마브레>"}은(는) 법령에 따른 개인정보 보유·이용기간 또는
      ...
      <ul>
        <li>
          ...
          동의일로부터[10년]까지 위 이용목적을 위하여 보유.이용됩니다.
        </li>
        <li>보유근거 : 사용자 식별 정보 보관</li>
      </ul>

      <h2>제3조(처리하는 개인정보의 항목)</h2>
      <p>{"<마브레>"}은(는) 다음의 개인정보 항목을 처리하고 있습니다.</p>
      <ol>
        <li>홈페이지 회원가입 및 관리</li>
      </ol>
      <ul>필수항목 : 서비스 이용 기록, 쿠키, MS OAuth ID</ul>
      <h2>제4조(개인정보의 파기절차 및 파기방법)</h2>
      <p>
        {"<마브레>"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
      ...
      <ol>
        <li>
          파기절차
          <br />
          {"<마브레>"} 은(는) 파기 사유가 발생한 개인정보를 선정하고, [ 마브레
      ...
      <ul>
        <li>
          정보주체는 {"<마브레>"}에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </li>
        <li>
          제1항에 따른 권리 행사는 {"<마브레>"}에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
          하실 수 있으며 {"<마브레>"}은(는) 이에 대해 지체 없이
          조치하겠습니다.
        </li>
        <li>
        ...
        <li>
          {"<마브레>"}은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
      ...
      <p>
        {"<마브레>"}은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
        취하고 있습니다.
      </p>
      <ol>
        <li>
        ...
        <li>
          해킹 등에 대비한 기술적 대책
          <br />
          [마브레]({"마브레 커뮤니티"})은 해킹이나 컴퓨터 바이러스 등에 의한
      ...
      <p>
        {"<마브레>"}은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
      ...
      <p>
        {"<마브레>"}은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여
        아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
      </p>
      <p>▶ 개인정보 보호책임자</p>
      <ul>
        <li>연락처 : admin@mabre.org (서비스 관리자)</li>
      </ul>
      <p>
        정보주체께서는 {"<마브레>"}의 서비스(또는 사업)을 이용하시면서 발생한
        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자에게 문의하실 수 있습니다. {"<마브레>"}은(는)
        정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
      </p>
      <h2>제9조(개인정보의 열람청구를 접수·처리하는 부서)</h2>
      <p>
        정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를
        아래의 부서에 할 수 있습니다. {"<마브레>"}은(는) 정보주체의 개인정보
      ...
      <p>이 개인정보처리방침은 2022년 6월 13부터 적용됩니다.</p>
